        ...
        <div className="flex-1 flex flex-col md:flex-row items-center justify-center px-6 md:px-16 lg:px-24 gap-8 lg:gap-16 py-8 h-[calc(100vh-76px)]">
          ...
          <div className="w-full md:w-1/2 flex flex-col space-y-8">
            <motion.div
              ...
              className="space-y-6"
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-black dark:text-white">
                Gilz AI: Resume Screening
              </h1>
              
              <p className="text-lg text-black/80 dark:text-white/80 max-w-xl">
              ...
              <div className="space-y-4 mt-6">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#7efb98] mt-1" />
                  <div>
                    <h3 className="text-lg font-medium text-black dark:text-white">AI Resume Analysis</h3>
                    <p className="text-black/70 dark:text-white/70">Automatically extract key information and evaluate candidate resumes.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#7efb98] mt-1" />
                  <div>
                    <h3 className="text-lg font-medium text-black dark:text-white">Candidate Comparison</h3>
                    <p className="text-black/70 dark:text-white/70">Compare multiple candidates with side-by-side analysis and skill matching.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#7efb98] mt-1" />
                  <div>
                    <h3 className="text-lg font-medium text-black dark:text-white">AI-Powered Assistant</h3>
                    <p className="text-black/70 dark:text-white/70">Get insights and recommendations from our intelligent chat assistant.</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-white/10 dark:bg-black/10 backdrop-blur-md border border-black/5 dark:border-white/5 rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-medium text-black dark:text-white mb-6">Get Started</h2>
