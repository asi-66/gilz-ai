  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <WarpBackground 
          className="py-16 md:py-20 px-6 min-h-[80vh] flex items-center justify-center" 
          gridColor="rgba(126, 251, 152, 0.3)"
          beamSize={4}
          beamsPerSide={4}
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p
              ...
              className="text-xl text-white/80 mb-8 glass-morphism p-4 rounded-lg max-w-2xl mx-auto"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="glass-morphism border-none shadow-none">
                <CardContent className="p-6">
                  ...
                  <CardTitle className="text-xl font-semibold text-white mb-2">AI Resume Analysis</CardTitle>
              ...
              <Card className="glass-morphism border-none shadow-none">
                <CardContent className="p-6">
                  ...
                  <CardTitle className="text-xl font-semibold text-white mb-2">Candidate Comparison</CardTitle>
                  <p className="text-white/80">
              ...
              <Card className="glass-morphism border-none shadow-none">
                <CardContent className="p-6">
                  ...
                  <CardTitle className="text-xl font-semibold text-white mb-2">AI-Powered Assistant</CardTitle>
                  <p className="text-white/80">
